  ...
  return (
    <div className="page-container">
      <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center', paddingTop: 'var(--space-8)' }}>
        ...
        {/* Success Icon */}
        <div style={{ width: '64px', height: '64px', background: 'var(--color-success-muted)', border: '2px solid var(--color-success-emphasis)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto var(--space-6)', fontSize: '28px' }}>
          ✓
        </div>
